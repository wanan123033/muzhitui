...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private TextView mTvNeedChooseCount;
    private TextView mTvNum;
    private LinearLayout mLlytMake;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mFunctionConfig == null || mThemeConfig == null) {
            ...
            findViews();
            setListener();
            String btnText = getIntent().getStringExtra(BUTTON_TEXT);
            if(btnText != null && !btnText.isEmpty())
                mTvMake.setText(btnText);
    ...
    private void findViews() {
        ...
        mTvNeedChooseCount = (TextView) findViewById(R.id.tvNeed);
        ...
        mLlytMake = (LinearLayout) findViewById(R.id.llytMake);
        mTvMake = (TextView) findViewById(R.id.tvMake);
//        mLlytMake.setEnabled(false);
    }
    ...
    private void setListener() {
        ...
        mLlytMake.setOnClickListener(this);
    }
    ...
    public void refreshSelectCount() {
        ...
        mTvNum.setText(String.valueOf(mSelectPhotoMap.size()));
        if (mFunctionConfig.getMaxSize() > MAXNUM) {
            mTvNeedChooseCount.setText(getString(R.string.need_selected, mFunctionConfig.getMaxSize() - mSelectPhotoMap.size()));
        } else {
            if (mSelectPhotoMap.size() >= 1) {
                mLlytMake.setEnabled(true);
            }
            mTvNeedChooseCount.setText("请选择一张或一组图片");
        }
        if (mSelectPhotoMap.size() == mFunctionConfig.getMaxSize()) {
            mLlytMake.setEnabled(true);
            mTvNeedChooseCount.setText("");
        }
