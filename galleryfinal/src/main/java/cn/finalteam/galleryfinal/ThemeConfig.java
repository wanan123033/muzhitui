...
public class ThemeConfig {
    ...
    public static class Builder {
        private int titleBarTextColor = Color.parseColor("#222222");
        private int titleBarBgColor = Color.WHITE;
        private int titleBarIconColor = Color.parseColor("#222222");
        ...
        private int iconCheck = R.drawable.ic_make_choosed;
