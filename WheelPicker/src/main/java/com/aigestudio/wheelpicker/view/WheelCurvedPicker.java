...
public class WheelCurvedPicker extends WheelCrossPicker {
    ...
    protected void drawItems(Canvas canvas) {
        for (int i = -itemIndex; i < data.size() - itemIndex; i++) {
            ...
            if (mLtTypeFace != null && !mLtTypeFace.isEmpty())
                mTextPaint.setTypeface(mLtTypeFace.get(i + itemIndex));
    ...
    private List<Typeface> mLtTypeFace;

    public void setTypeFace(List<Typeface> mList) {
        mLtTypeFace = mList;
    }
