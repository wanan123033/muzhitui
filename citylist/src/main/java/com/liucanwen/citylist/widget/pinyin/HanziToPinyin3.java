...
/**
 * An object to convert Chinese character to its corresponding com.liucanwen.citylist.pinyin string. For characters with
 * multiple possible com.liucanwen.citylist.pinyin string, only one is selected according to collator. Polyphone is not
 ...
 * implementation highly depends on zh_CN ICU collation com.liucanwen.citylist.data and must be always synchronized with
 * ICU.
 *
...
public class HanziToPinyin3 {
    ...
    // Turn on this flag when we want to check internal com.liucanwen.citylist.data structure.
    private static final boolean DEBUG = false;

    /**
     * Unihans array.
     *
     * Each unihans is the first one within same com.liucanwen.citylist.pinyin when collator is zh_CN.
     */ 
     ...
     * Pinyin array.
     *
     * Each com.liucanwen.citylist.pinyin is corresponding to unihans of same
    ...
    public static HanziToPinyin3 getInstance() {
        synchronized (HanziToPinyin3.class) {
            ...
            // Check if zh_CN collation com.liucanwen.citylist.data is available
     ...
     * space will be put into a Token, One Hanzi character which has com.liucanwen.citylist.pinyin will be treated as a
