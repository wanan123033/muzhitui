...
public class QuickReply implements Serializable {
    ...
    private List<VedioText.PageListBean> pageList;
    ...
    public List<VedioText.PageListBean> getPageList() {
        return pageList;
    }

    public void setPageList(List<VedioText.PageListBean> pageList) {
