...
public class SexPickerView implements CanShow, OnWheelChangedListener {
...
*/
    ...
    private SexPickerView.OnCityItemClickListener listener;
    ...
    public void setOnCityItemClickListener(SexPickerView.OnCityItemClickListener listener) {
    ...
    private SexPickerView(SexPickerView.Builder builder) {
    ...
    public static class Builder {
         ...
         * @return
         */
        public SexPickerView.Builder backgroundPop(int backgroundPopColor) {
         ...
         * @return
         */
        public SexPickerView.Builder titleBackgroundColor(String colorBg) {
         ...
         * @return
         */
        public SexPickerView.Builder titleTextColor(String titleTextColorStr) {
         ...
         * @return
         */
        public SexPickerView.Builder title(String mtitle) {
            this.mTitle = mtitle;
            return this;
        }
         ...
         * @return
         */
        public SexPickerView.Builder onlyShowProvinceAndCity(boolean flag) {
         ...
         * @return
         */
        public SexPickerView.Builder province(String defaultProvinceName) {
         ...
         * @return
         */
        public SexPickerView.Builder city(String defaultCityName) {
         ...
         * @return
         */
        public SexPickerView.Builder district(String defaultDistrict) {
         ...
         * @return
         */
        public SexPickerView.Builder confirTextColor(String color) {
         ...
         * @return
         */
        public SexPickerView.Builder cancelTextColor(String color) {
         ...
         * @return
         */
        public SexPickerView.Builder textColor(int textColor) {
         ...
         * @return
         */
        public SexPickerView.Builder textSize(int textSize) {
         ...
         * @return
         */
        public SexPickerView.Builder visibleItemsCount(int visibleItems) {
         ...
         * @return
         */
        public SexPickerView.Builder provinceCyclic(boolean isProvinceCyclic) {
         ...
         * @return
         */
        public SexPickerView.Builder cityCyclic(boolean isCityCyclic) {
         ...
         * @return
         */
        public SexPickerView.Builder districtCyclic(boolean isDistrictCyclic) {
         ...
         * @return
         */
        public SexPickerView.Builder itemPadding(int itemPadding) {
            this.padding = itemPadding;
            return this;
        }

        public SexPickerView build() {
            SexPickerView cityPicker = new SexPickerView(this);
            return cityPicker;
        }
...
//        updateAreas();
    ...
    protected void initProvinceDatas(Context context) {
        ...
        try {
            InputStream input = asset.open("sex.xml");
            // 创建一个解析xml的工厂对象
