...
public class CateGoryPickerView  implements CanShow, OnWheelChangedListener {
...
*/
    ...
    private CateGoryPickerView.OnCityItemClickListener listener;
    ...
    public void setOnCityItemClickListener(CateGoryPickerView.OnCityItemClickListener listener) {
    ...
    private CateGoryPickerView(CateGoryPickerView.Builder builder) {
    ...
    public static class Builder {
         ...
         * @return
         */
        public CateGoryPickerView.Builder backgroundPop(int backgroundPopColor) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder titleBackgroundColor(String colorBg) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder titleTextColor(String titleTextColorStr) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder title(String mtitle) {
            this.mTitle = mtitle;
            return this;
        }
         ...
         * @return
         */
        public CateGoryPickerView.Builder onlyShowProvinceAndCity(boolean flag) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder province(String defaultProvinceName) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder city(String defaultCityName) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder district(String defaultDistrict) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder confirTextColor(String color) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder cancelTextColor(String color) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder textColor(int textColor) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder textSize(int textSize) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder visibleItemsCount(int visibleItems) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder provinceCyclic(boolean isProvinceCyclic) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder cityCyclic(boolean isCityCyclic) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder districtCyclic(boolean isDistrictCyclic) {
         ...
         * @return
         */
        public CateGoryPickerView.Builder itemPadding(int itemPadding) {
            this.padding = itemPadding;
            return this;
        }

        public CateGoryPickerView build() {
            CateGoryPickerView cityPicker = new CateGoryPickerView(this);
            return cityPicker;
        }
...
//        updateAreas();
    ...
    protected void initProvinceDatas(Context context) {
        ...
        try {
            InputStream input = asset.open("category.xml");
            // 创建一个解析xml的工厂对象
